...
public class Strategy extends ClassMethodsStrategy implements
		ICompletionStrategy {
	...
	public void apply(ICompletionReporter reporter) throws BadLocationException {
		...
		IType[] types = ContextParser.getTypesFor(aContext.getSourceModule(),
	...
	private List<IMethod> getMethodsFromTypes(IType[] types, String prefix,
			boolean exactName, Context concreteContext) {
